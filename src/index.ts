...
import {KVStorage} from "./network/storage/kv";
import {BrowserClient} from "./network/client/browser";
...
// const entryPriKey = aes.encrypt(tokenPri, secPri)
...
// const entryPri2 = 'bc287af729e813783dabf7d6eaf3ba7ccf1fb52eb1bc25f0b080d67690c00517f8d9351b47941a9725917c8f4a7fe9688786b49bd945795200551480aaca2d8211d5d8212cf65b6c090fb92e58737cb8c32dc40b20cb4604ecaa4f2759c7310e'
// const decryptPriKey = aes.decrypt(entryPriKey, secPri)
...
network.use(new KVStorage(), new BrowserClient())
